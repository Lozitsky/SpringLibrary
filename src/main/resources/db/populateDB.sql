...
INSERT INTO `spring_library`.author (full_name, birthday) VALUES ('назва книги', '1999-01-01');
INSERT INTO `spring_library`.genre (name) VALUES ('якийсь жанр');
INSERT INTO `spring_library`.publisher (name) VALUES ('якийсь видавець');
INSERT INTO `spring_library`.book (name, content, page_count, isbn, genre_id, author_id, publish_year, publisher_id, image) VALUES ('якась назва', ?, '123', '123-123-123-123', '1', '1', '1999', '1', ?);
